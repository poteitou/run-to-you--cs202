      ...
      mTitle("", context.mFonts->get(Fonts::Title), 110)
{
    ...
    mButtons[0] = std::make_shared<Button>(context, Textures::ButtonReplay);
    mButtons[0]->setPosition(0.5f * 1600.f - 105.f, 0.6f * 900.f);

    mButtons[1] = std::make_shared<Button>(context, Textures::ButtonQuit);
    mButtons[1]->setPosition(0.5f * 1600.f + 105.f, 0.6f * 900.f);
}
