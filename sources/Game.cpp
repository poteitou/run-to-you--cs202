...
, mIsPaused(false)
{
	...
	mTextures.load(Textures::ButtonResume, "resources/textures/ButtonResume.png");
	mTextures.load(Textures::ButtonReplay, "resources/textures/ButtonReplay.png");
	...
	mTextures.load(Textures::ButtonQuit, "resources/textures/ButtonQuit.png");
	mTextures.load(Textures::ButtonSkip, "resources/textures/ButtonSkip.png");
	mTextures.load(Textures::ButtonEsc, "resources/textures/ButtonEsc.png");
	mTextures.load(Textures::ButtonUp, "resources/textures/ButtonUp.png");
	...
	mSoundBuffers.load(Sounds::Countdown, "resources/sounds/Countdown.wav");
